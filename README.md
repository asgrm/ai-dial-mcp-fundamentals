...
1. Open [mcp_client](agent/mcp_client.py) and implement all **_TODO_**
2. Open [dial_client](agent/dial_client.py) and implement all **_TODO_**
3. Open [prompts](agent/prompts.py) and write System prompt
4. Open [app](agent/app.py) and implement all **_TODO_**
